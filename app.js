...
//spawn process for python code to run
 ...
 */
var iotPlatformServiceName = 'homeautomationiot-iotf-service';
...
appClient.on("deviceEvent", function(deviceType, deviceId, eventType, format, payload){
  ...
  // }
  // else {
    console.log('Got other events of ' + eventType + ' from ' + deviceId + ':' + payload);
    sensorData.payload = JSON.parse(payload);
  // } 
});

app.get('/sensordata', raspberryPiServer.returnCurrentSensorData(sensorData));

app.post('/changeswitch',function(req,res){
  // console.log("in changeswitch");
  // console.log(req.body['data']);
  var process = spawn('python',['./deviceScripts/server.py',req.body['data']]);
